...
-- drop database triggers_eventos_t2;
...
select d.department_id,d.department_name, avg(e.salary) from departments d 
inner join employees e on d.department_id= e.department_id 
inner join locations l on l.location_id=d.location_id group by 1 ;


-- lista de empleos con su trabajo, departamento y ubicacion,
select e.first_name as employee_name, e.last_name as employee_last_name,
j.job_title, d.department_name, l.city as location_city from employees e inner join jobs j on j.job_id=e.job_id  

...
select * from pedido where fecha_pedido >= '2009-01-01';
...
select nombre_cliente, empleado.nombre, empleado.apellido1, pago.codigo_cliente from cliente inner join empleado inner join pago where codigo_empleado_rep_ventas=empleado.codigo_empleado and pago.codigo_cliente= cliente.codigo_cliente;
...
select nombre_cliente, empleado.nombre, empleado.apellido1, pago.codigo_cliente, oficina.ciudad from cliente inner join empleado inner join pago inner join oficina where codigo_empleado_rep_ventas=empleado.codigo_empleado and pago.codigo_cliente= cliente.codigo_cliente and empleado.codigo_oficina= oficina.codigo_oficina;
...
select linea_direccion1, linea_direccion2 from oficina;
...
select nombre_cliente, empleado.nombre, empleado.apellido1, oficina.ciudad from cliente inner join empleado inner join pago inner join oficina where codigo_empleado_rep_ventas=empleado.codigo_empleado and empleado.codigo_oficina= oficina.codigo_oficina;
